...
/// <summary>�ndert den physikalischen Typ der Einheit.</summary>
...
/// <summary>Weist der Instanz einen neuen Wert zu. Dieser wird in die g�ltige physikalische Einheit abgebildet.</summary>
...
/// <summary>Addiert zu einer bestehenden Instanz eine Temperatur dazu. Die physikalische Einheit wird ber�cksichtigt.</summary>
/// <param name="value">Addent</param>
/// <returns>Referenz auf Instanz</returns>
Temperature& operator+= (const Temperature& value)
{
...
/// <summary>Subtrahiert zu einer bestehenden Instanz eine Temperatur ab. Die physikalische Einheit wird ber�cksichtigt.</summary>
/// <param name="value">Subtrahend</param>
/// <returns>Referenz auf Instanz</returns>
Temperature& operator-= (const Temperature& value)
{
...
/// <summary>
/// Erh�ht die Temperatur um 1� der jeweilig eingestellten physikalischen Einheit (Prefix).
/// </summary>
...
/// <summary>
/// Erh�ht die Temperatur um 1� der jeweilig eingestellten physikalischen Einheit (Postfix).
/// </summary>
...
/// <summary>
/// Ausgabeoperator f�r iostream darf auf interne/private Daten zugreifen
/// </summary>
...
/// <summary>�ndert den internen Temperaturwert auf Basis �K</summary>
/// <param name="value">Neuer Temperaturwert</param>
void Temperature::fromKelvin(const float value)
{
	kelvin = dynamic_cast<uint32_t>(value * 100);
}
/// <summary>�ndert den internen Temperaturwert auf Basis �C</summary>
/// <param name="value">Neuer Temperaturwert</param>
void Temperature::fromCelsius(const float value)
{
	kelvin = dynamic_cast<uint32_t>(value * 100 + 27315);
}
/// <summary>�ndert den internen Temperaturwert auf Basis �F</summary>
/// <param name="value">Neuer Temperaturwert</param>
void Temperature::fromFahrenheit(const float value)
{
	kelvin = dynamic_cast<uint32_t>((value - 32) * 5 / 9 * 100 + 27315);
}
/// <summary>�ndert den internen Temperaturwert auf Basis der aktuelle eingestellten phsikalischen Einheit</summary>
/// <param name="value">Neuer Temperaturwert</param>
